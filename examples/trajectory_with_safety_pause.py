...
def save_state(state: TrajectoryState) -> None:
    ...
    logger.info(f"Saved state: location={state.trajectory_location:.3f}, paused={state.is_paused}, joint_position={state.paused_joint_position}")
...
def load_state() -> TrajectoryState | None:
    ...
    try:
        ...
        logger.info(f"Loaded state: location={state.trajectory_location:.3f}, paused={state.is_paused}, joint_position={state.paused_joint_position}")
        return state
