...
1. Make sure no server is running in the port. Check the **main**.py file to see which port is used
...
9. Congratulate the user on successfully starting the program.
