...
from nova.viewers import Viewer, ViewerManager, Rerun, get_viewer_manager
...
class TestRerunViewer:
    ...
    async def test_rerun_viewer_log_planning_success(self, mock_bridge_class):
        ...
        await viewer.log_planning_success(mock_actions, mock_trajectory, mock_tcp, mock_motion_group)
...
class TestViewerManager:
    ...
    async def test_log_planning_success(self):
        ...
        await manager.log_planning_success(mock_actions, mock_trajectory, mock_tcp, mock_motion_group)
        
        viewer1.log_planning_success.assert_called_once_with(mock_actions, mock_trajectory, mock_tcp, mock_motion_group)
        viewer2.log_planning_success.assert_called_once_with(mock_actions, mock_trajectory, mock_tcp, mock_motion_group)
    ...
    async def test_log_planning_failure(self):
        ...
        viewer1.log_planning_failure.assert_called_once_with(mock_actions, mock_error, mock_tcp, mock_motion_group)
        viewer2.log_planning_failure.assert_called_once_with(mock_actions, mock_error, mock_tcp, mock_motion_group)
...
class TestPublicAPI:
    ...
    def test_public_api_exports(self):
        ...
        from nova.viewers import (
            Viewer, ViewerManager, Rerun, NovaRerunBridgeProtocol, get_viewer_manager
        )
