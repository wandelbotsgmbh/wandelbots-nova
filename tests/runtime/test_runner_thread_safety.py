...
def test_concurrent_start_attempts(sample_program, mock_robot_cell):
    ...
    runner = ThreadSafeProgramRunner(sample_program, {}, execution_delay=0.1, robot_cell_override=mock_robot_cell)
...
def test_stop_thread_safety(sample_program, mock_robot_cell):
    ...
    runner = ThreadSafeProgramRunner(sample_program, {}, execution_delay=1.0, robot_cell_override=mock_robot_cell)
...
def test_multiple_runners_independence(sample_program, mock_robot_cell):
    ...
    runners = [ThreadSafeProgramRunner(sample_program, {}, robot_cell_override=mock_robot_cell) for _ in range(5)]
...
def test_join_thread_safety(sample_program, mock_robot_cell):
    ...
    runner = ThreadSafeProgramRunner(sample_program, {}, execution_delay=0.2, robot_cell_override=mock_robot_cell)
