...
- **deps**: Bump python-semantic-release/publish-action from 9.8.9 to 9.19.0
...
- **deps**: Bump python-semantic-release/python-semantic-release from 9.11.1 to 9.19.0
...
- Move back to home in example ([#60](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/60),
...
- Add various collider types ([#58](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/58),
...
- Fixed nova-rerun-bridge extras ([#59](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/59),
...
- **deps-dev**: Bump ruff from 0.8.6 to 0.9.6
...
- Only plan and not execute in welding example
...
- Simple check for http prefix ([#42](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/42),
...
- Add optional rerun bridge ([#45](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/45),
...
- Enhance trajectory planning with optional starting joint position
...
- Added __eq__ to vector and pose ([#48](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/48),
...
- Streaming execution first draft ([#43](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/43),
...
- Propagate robot state in motion group
...
- Added active tcp to abstract robot
...
- Get active_tcp_name & added motion_settings to var name
...
- **RPS-1206**: Implemented I/O access, read & write
...
- Make robot cell devices readable
...
- Enable example tests in CI ([#39](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/39),
...
- **RPS-898**: Implemented robotcell + execute * abstract robot and deps
...
- Update wandelbots_api_client to version 25.1.0
...
- Exception naming ([#36](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/36),
...
- Make authorization flow asynchron.
...
- Expose error object in exception
...
- Improved example descriptions ([#33](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/33),
...
- **RPS-976**: Added integration test CI
...
- Add Auth0 device code authorization and refresh token flow
...
- Expose virtual robot api ([#30](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/30),
...
- Expose store collision scene api
...
- Add support for motion setting ([#23](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/23),
...
- **RPS-1086**: Add option to close the nova object
...
- Added .activated_motion_groups to fetch all motion groups from con
...
- **RPS-1034**: Added mypy check to CI * updated API * added pose transform
...
- **RPS-1027**: Separated plan and execute in motion group
...
- **RPS-1004**: Handle https, add some convenience methods
...
- Added yamllint ([#14](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/14),
...
- Make motion_group plan call public
...
- Updated nova interface and simplified examples
...
- **RPS-999**: Activate motion groups seperatly
...
- Add pre-commit ([#10](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/10),
...
- Not always use "Flange" as a parameter for tcp in _load_planned_motion
...
- Don't publish pi from nova package
...
- Added editorconfig * fixed poetry build
  ([`6f89ce8`](https://github.com/wandelbotsgmbh/wandelbots-nova/commit/6f89ce8ad9443a73b8198475b3ba50c4b69636f6))

- Ci fixes
  ([`9b5a7de`](https://github.com/wandelbotsgmbh/wandelbots-nova/commit/9b5a7de1cea2472cd1cbff909f49d63b8b519188))

- Only run integration test manually for now
  ([`1352938`](https://github.com/wandelbotsgmbh/wandelbots-nova/commit/1352938a619f2dc0e20f6a79a8c81d23e8a0356f))

### Features

- Implement examples & improved type interfaces & motion interface
  ([#4](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/4),
  [`3273dfe`](https://github.com/wandelbotsgmbh/wandelbots-nova/commit/3273dfebc5b4463618120cef00f98a1f3b87ed01))

Co-authored-by: cbiering <christoph.biering@wandelbots.com>

- **examples**: Added examples to show the usage of nova-python-sdk
  ([#2](https://github.com/wandelbotsgmbh/wandelbots-nova/pull/2),
  [`f08f793`](https://github.com/wandelbotsgmbh/wandelbots-nova/commit/f08f793df329cfd43465ebcf25ff4b49bdf864ff))
