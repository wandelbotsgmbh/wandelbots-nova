...
from nova_python_app.backbone.discovery import setup_program_discovery
from .services_registry import register_api_services, initialize_api_services
from .factory import create_nova_api_app, add_health_endpoints, configure_cors
...
def print_database_stats(container: NovaContainer) -> None:
    ...
    print(f"Database loaded: {stats['template_count']} templates, {stats['instance_count']} instances")
