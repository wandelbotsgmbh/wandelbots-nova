...
def register_api_services(container: "NovaContainer") -> None:
    ...
    """
    from .services import ProgramAPIService, ProgramExecutionService, ProgramRunAPIService
...
def initialize_api_services(container: "NovaContainer") -> None:
    ...
    services_to_initialize = [container.program_api_service(), container.program_run_api_service()]
...
def get_service_health_status(container: "NovaContainer") -> dict:
    ...
    """
    health_status = {"services": {}, "overall_status": "healthy"}

    service_names = ["program_api_service", "program_run_api_service", "program_execution_service"]
