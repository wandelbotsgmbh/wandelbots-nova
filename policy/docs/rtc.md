...
In `gr00t/policy/server_client.py`:
```python
...
**Critical finding**: In `gr00t/policy/gr00t_policy.py` (line 408):
```python
...
```python
# In gr00t/policy/gr00t_policy.py, line ~408:
...
- Server: `gr00t/policy/server_client.py` (PolicyServer/PolicyClient)
- Policy API: `gr00t/policy/gr00t_policy.py` (Gr00tPolicy._get_action)
