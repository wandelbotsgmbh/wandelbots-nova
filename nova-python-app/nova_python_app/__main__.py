...
from novax import create_container, create_nova_api_app
from novax.interfaces import ProgramDiscoveryServiceInterface


class MyProgramDiscoveryService(ProgramDiscoveryServiceInterface):
    pass
